...
* standard tricks
   ...
   * sequential (Gibbs) sampling/conditional distributions
   * Metropolis-Hastings
...
* augment position (current parameter values) with "momentum"; randomly perturb momentum at each step, integrate dynamics
* leapfrog integration: have to pick stepsize/number of steps
* No-U-Turn sampler: integrate until trajectory starts to turn back
...
* discrete latent variables ("Rao-Blackwellization", @robertRaoBlackwellization2021a); marginalize/find conditional expectation
